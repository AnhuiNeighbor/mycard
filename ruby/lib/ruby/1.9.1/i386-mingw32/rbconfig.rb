...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--disable-install-doc' '--with-tcl-dir=C:/projects/rubyinstaller-git/sandbox/tcl' '--with-tk-dir=C:/projects/rubyinstaller-git/sandbox/tk' '--with-tklib=tk85-ri' '--with-tcllib=tcl85-ri' '--prefix=' 'LDFLAGS='"
  ...
  CONFIG["RUBY_RELEASE_DATE"] = "2012-02-19"
